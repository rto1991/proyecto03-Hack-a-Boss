...
router.post("/updateUser/:id", userExists, isUser, updateUser); //actualizar datos usuario (solo puede modificar los de si mismo si es usuario normal, si es admin puede modificar el que quiera) *probado*
router.delete("/deleteUser/:id", deleteUser);
router.post("/login", loginUser); // login *PROBADO*
router.post("/users/changePassword/:id", modifyPwd); //modificar contraseña *PROBADO*
